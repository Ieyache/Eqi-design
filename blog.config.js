...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Ieya Che', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'E栖设计，一起生活', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://Eqisheji.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '室内设计, 设计, 官网,  E栖, E栖设计, Eqi设计, EQ设计', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '浙ICP备19940611', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://beian.miit.gov.cn/', // 备案查询链接，如果用了萌备等备案请在这里填写
  BEI_AN_GONGAN: process.env.NEXT_PUBLIC_BEI_AN_GONGAN || '浙ICP备19940611', // 公安备案号，例如 '浙公网安备3xxxxxxxx8号'
